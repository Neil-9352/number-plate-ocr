...
# INPUT_DIR = "dataset/cropped"       # folder with cropped plate images
# OUTPUT_DIR = "training_data"        # folder for Tesseract training data
# os.makedirs(OUTPUT_DIR, exist_ok=True)

# RPM_LIMIT = 10                       # requests per minute
# SLEEP_TIME = 60 / RPM_LIMIT          # seconds per request (~6s)
...
#     plate_text = response.text.strip().replace(" ", "").upper()
#     return plate_text
